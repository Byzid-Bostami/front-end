...
const page = async () => {
  ...
  const techPosts = publicPosts.filter((post) => post.category === "tech");
  const firstPost = techPosts[0];
  const othertechPosts = techPosts.slice(1);
  ...
  return (
    <div className="space-y-10 pb-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 items-stretch">
        {othertechPosts.length > 0 ? (
          othertechPosts.map((post) => (
